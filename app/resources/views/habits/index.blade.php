  ...
  <table class="table table-bordered">
    ...
    @foreach($habits as $habit)
      <tr>
        ...
        <td>
          <a href="{{ route('user.habits.edit', ['habit' => $habit->id]) }}" class="btn btn-sm btn-secondary">編集</a>
          <form action="{{ route('user.habits.destroy', ['habit' => $habit->id]) }}" method="POST" style="display:inline-block">
            @csrf
            @method('DELETE')
